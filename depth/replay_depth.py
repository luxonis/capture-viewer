...
def replay(frames, *, calib=None, stereo_config:str='', fps:int=30, outputs:Set[str]={'depth',}, timeout_s:int = 2):
    """
    Args:
    ...
    with get_device() as device:
        ...
        queues = {name: device.getOutputQueue(name, 4, False) for name in xOut.keys()}
